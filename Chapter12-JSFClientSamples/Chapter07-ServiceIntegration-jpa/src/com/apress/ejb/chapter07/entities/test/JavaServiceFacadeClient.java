...
public class JavaServiceFacadeClient {
  public static void main(String[] args) {
    try {
      ...
      //      for (Distributor distributor : (List<Distributor>)javaServiceFacade.getDistributorFindAll()) {
      //        printDistributor(distributor);
      //      }
      //      for (OrderItem orderitem : (List<OrderItem>)javaServiceFacade.getOrderItemFindAll()) {
      //        printOrderItem(orderitem);
      //      }
      //      for (Supplier supplier : (List<Supplier>)javaServiceFacade.getSupplierFindAll()) {
      //        printSupplier(supplier);
      //      }
      //      for (WineItem wineitem : (List<WineItem>)javaServiceFacade.getWineItemFindAll()) {
      //        printWineItem(wineitem);
      //      }
      //      for (Individual individual : (List<Individual>)javaServiceFacade.getIndividualFindAll()) {
      //        printIndividual(individual);
      //      }
      //      for (Customer customer : (List<Customer>)javaServiceFacade.getCustomerFindAll()) {
      //        printCustomer(customer);
      //      }
      //      for (Address address : (List<Address>)javaServiceFacade.getAddressFindAll()) {
      //        printAddress(address);
      //      }
      //      for (InventoryItem inventoryitem : (List<InventoryItem>)javaServiceFacade.getInventoryItemFindAll()) {
      //        printInventoryItem(inventoryitem);
      //      }
      //      for (CartItem cartitem : (List<CartItem>)javaServiceFacade.getCartItemFindAll()) {
      //        printCartItem(cartitem);
      //      }
      //      for (Wine wine : (List<Wine>)javaServiceFacade.getWineFindAll()) {
      //        printWine(wine);
      //      }
      ...
      //      for (BusinessContact businesscontact : (List<BusinessContact>)javaServiceFacade.getBusinessContactFindAll()) {
      //        printBusinessContact(businesscontact);
      //      }
      //      for (CustomerOrder customerorder : (List<CustomerOrder>)javaServiceFacade.getCustomerOrderFindAll()) {
