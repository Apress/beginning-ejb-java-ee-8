...
/**
 * To create ID generator table "BUSINESS_CONTACT_ID_GEN": CREATE TABLE "BUSINESS_CONTACT_ID_GEN"
 * ("PRIMARY_KEY_NAME" VARCHAR2(4000) PRIMARY KEY, "NEXT_ID_VALUE" NUMBER(38));
 *
 * To initialize this table with data for this entity's ID generator 'BusinessContact.id' (starting
 * with value '0'): INSERT INTO "BUSINESS_CONTACT_ID_GEN" VALUES ('BusinessContact.id', 0);
 */
@Entity
