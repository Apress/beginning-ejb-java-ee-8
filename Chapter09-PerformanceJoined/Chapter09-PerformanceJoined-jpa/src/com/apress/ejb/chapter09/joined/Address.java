...
/**
 * To create ID generator table "ADDRESS_ID_GEN": CREATE TABLE
 * "ADDRESS_ID_GEN" ("PRIMARY_KEY_NAME" VARCHAR2(4000) PRIMARY KEY,
 * "NEXT_ID_VALUE" NUMBER(38));
 *
 * To initialize this table with data for this entity's ID generator
 * 'Address.id' (starting with value '0'): INSERT INTO
 * "ADDRESS_ID_GEN" VALUES ('Address.id', 0);
 */
@Entity
@NamedQueries({
