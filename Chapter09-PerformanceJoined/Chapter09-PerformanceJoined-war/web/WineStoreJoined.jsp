...
<f:view>
  <html>
    <head>
      ...
      <title>Performance test for WineStoreJoined application</title>
      <style type="text/css">
        body {
    ...
    <body><h:form>
        ...
        <p>
          <h:selectOneListbox value="#{WineStoreJoinedBean.wineKey}"
                              id="selectOneListbox1">
            <f:selectItems value="#{WineStoreJoinedBean.wineDisplayList}"/>
          </h:selectOneListbox>
        </p>
        <p>
          Enter Quantity
        ...
        <p>
          <h:inputText value="#{WineStoreJoinedBean.qty}"/>
        </p>
        <p>
