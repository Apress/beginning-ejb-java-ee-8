...
public class JavaServiceFacade {
  ...
  public JavaServiceFacade() {
    ...
    final EntityManagerFactory emf = Persistence.createEntityManagerFactory("Chapter04-PersistenceIISamples-EmbeddedId");
  ...
  public void removePerson(Person person) {
    person = em.find(Person.class, person.getMyId());
    em.remove(person);
    commitTransaction();
  }
