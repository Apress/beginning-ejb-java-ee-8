 ...
 *
 * To create ID generator table "CH04_TPC_ADDRESS_ID_GEN":
 * CREATE TABLE "CH04_TPC_ADDRESS_ID_GEN" ("PRIMARY_KEY_NAME" VARCHAR2(4000) PRIMARY KEY, "NEXT_ID_VALUE" NUMBER(38));
 *
 * To initialize this table with data for this entity's ID generator 'Address.id' (starting with value '0'):
 * INSERT INTO "CH04_TPC_ADDRESS_ID_GEN" VALUES ('Address.id', 0);
 */
@Entity
@NamedQueries({ @NamedQuery(name = "Address.findAll", query = "select o from Address o") })
@Table(name = "CH04_TPC_ADDRESS")
@TableGenerator(name = "Address_ID_Generator", table = "CH04_TPC_ADDRESS_ID_GEN", pkColumnName = "PRIMARY_KEY_NAME",
