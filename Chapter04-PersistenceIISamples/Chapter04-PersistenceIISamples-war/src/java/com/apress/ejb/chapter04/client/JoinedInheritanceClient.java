...
import com.apress.ejb.chapter04.joined.Address;
import com.apress.ejb.chapter04.joined.Employee;
import com.apress.ejb.chapter04.joined.FullTimeEmployee;
import com.apress.ejb.chapter04.joined.PartTimeEmployee;
import com.apress.ejb.chapter04.joined.Person;
import com.apress.ejb.chapter04.joined.service.JavaServiceFacade;
 ...
 * @author jwetherb
 */
@WebServlet(name = "JoinedInheritanceClient", urlPatterns = {"/JoinedInheritanceClient"})
public class JoinedInheritanceClient extends HttpServlet {
  /**
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.println("<html>");
      out.println("<head>");
      out.println("<title>Servlet JoinedInheritanceClient</title>");
      out.println("</head>");
      out.println("<body>");
      outH1(out, "Servlet JoinedInheritanceClient at " + request.getContextPath());
