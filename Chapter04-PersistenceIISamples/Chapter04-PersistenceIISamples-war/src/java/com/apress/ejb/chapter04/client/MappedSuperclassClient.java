...
import com.apress.ejb.chapter04.mappedsuperclass.service.JavaServiceFacade;
 ...
 * @author jwetherb
 */
@WebServlet(name = "MappedSuperclassClient", urlPatterns = {"/MappedSuperclassClient"})
public class MappedSuperclassClient extends HttpServlet {
  /**
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.println("<html>");
      out.println("<head>");
      out.println("<title>Servlet MappedSuperclassClient</title>");
      out.println("</head>");
      out.println("<body>");
      outH1(out, "Servlet MappedSuperclassClient at " + request.getContextPath());
