...
import com.apress.ejb.chapter04.embeddable.service.JavaServiceFacade;
 ...
 * @author jwetherb
 */
@WebServlet(name = "EmbeddableClient", urlPatterns = {"/EmbeddableClient"})
public class EmbeddableClient extends HttpServlet {
  /**
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.println("<html>");
      out.println("<head>");
      out.println("<title>Servlet EmbeddableClient</title>");
      out.println("</head>");
      out.println("<body>");
      outH1(out, "Servlet EmbeddableClient at " + request.getContextPath());
  ...
  private Address createFTAddress() {
  ...
  private Address createPTAddress() {
    Address add;
    add = new Address();
