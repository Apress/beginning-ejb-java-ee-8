...
import com.apress.ejb.chapter04.tableperclass.service.JavaServiceFacade;
 ...
 * @author jwetherb
 */
@WebServlet(name = "TablePerClassInheritanceClient", urlPatterns = {"/TablePerClassInheritanceClient"})
public class TablePerClassInheritanceClient extends HttpServlet {
  /**
  ...
  protected void processRequest(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.println("<html>");
      out.println("<head>");
      out.println("<title>Servlet TablePerClassInheritanceClient</title>");
      out.println("</head>");
      out.println("<body>");
      outH1(out, "Servlet TablePerClassInheritanceClient at " + request.getContextPath());
